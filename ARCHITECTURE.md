...
flowchart TB
    ...
    subgraph FlaskServer["Flask Server (Python)"]
        ...
        subgraph Templates["Jinja2 Templates"]
            ...
            ComponentMacros["_components.html"]
        end
    ...
    %% Editor Flow
    Editor -->|"POST /render"| AppPy
    AppPy --> Renderer
    Renderer --> ComponentMacros
    ComponentMacros -->|"HTML"| AppPy
    AppPy -->|"HTML Response"| Editor
    ...
    class AppPy,Renderer,LLMService flask
...
flowchart TD
    ...
    subgraph SSR["ssr_python/"]
        ...
        subgraph Templates["templates/"]
            ...
            ComponentsHTML["macros/_components.html"]
        end
